...
if __name__ == "__main__":
    ...
    quantization_dataset = instanciate_module(
    ...
    quantized_model_path = os.path.join(export_config['export_path'], 'model_quantized.onnx')
    quantize_onnx_model(export_path, quantized_model_path, calibration_dataset=quantization_dataset)
