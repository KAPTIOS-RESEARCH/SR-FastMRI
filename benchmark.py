...
if __name__ == "__main__":
    ...
    logging.info(f"🟢 Non-Quantized Model | Avg Inference Time and PSNR: {t1:.2f} ms; {psnr1:.2f}")
    logging.info(f"🔥 Quantized Model | Avg Inference Time and PSNR: {t2:.2f} ms; {psnr2:.2f}")
